window.DCODE_PROJECTS = [
  {
    id: 'recruitment',
    order: '01',
    category: 'Zoho CRM · Native Automation · Deluge',
    title: 'Recruitment Operations Platform',
    subtitle: 'A Zoho-native recruitment operating system built with CRM configuration, workflow rules, custom Deluge functions, reporting, and recruiter-facing process controls.',
    status: 'Production Zoho system · reconstructed interface',
    role: 'Systems Architect · Zoho CRM Engineer · Automation Developer',
    stack: ['Zoho CRM / Recruit','Deluge','Workflow Rules','Blueprint','Schedules','Reports & Analytics','REST APIs','Webhooks'],
    metrics: [
      ['120K+','records in broader migration program'],
      ['Native','Zoho automation and custom functions'],
      ['89','documented successful function executions'],
      ['0','documented function failures in retained evidence']
    ],
    problem: 'Recruitment activity was spread across candidate records, job openings, employee records, facilities, reporting, scheduling, and internal follow-up. Recruiters needed one governed operating environment with consistent data, history, and automation.',
    solution: 'I designed the system inside Zoho so the CRM remained both the system of record and the automation layer. Native workflow rules, Blueprints, schedules, reports, and custom Deluge functions handled business logic close to the records instead of introducing unnecessary external middleware.',
    built: [
      'Applicant, employee, job opening, facility, task, meeting, and activity structures in Zoho, including familiar Kanban, tile, and table views.',
    ...
    architecture: ['Zoho Record Event','Workflow Rule / Blueprint','Validation','Deluge Business Logic','Related Records / Subforms','Verified Update','Reports / Analytics'],
    reliability: ['Defensive Deluge checks','Processing status','Subform history preservation','Post-write verification','Execution logs','Failure visibility'],
    outcome: 'The portfolio demo reconstructs the recruiter-facing Zoho environment from surviving interface screenshots and documented workflow/report requirements. Home and Analytics expose the dashboard, Reports opens a native report list, Workqueue follows the CRM workqueue layout, and the Settings path demonstrates workflow rules, schedules, Deluge functions, execution logs, and function analytics. Candidate and client records are synthetic; retained function metrics are non-client operational evidence.',
